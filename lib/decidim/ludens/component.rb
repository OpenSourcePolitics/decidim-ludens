...
Decidim.register_component(:ludens) do |component|
  component.engine = Decidim::Ludens::Engine
  component.admin_engine = Decidim::Ludens::AdminEngine
  component.icon = "decidim/ludens/icon.svg"
